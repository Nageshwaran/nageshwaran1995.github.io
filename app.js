...
myApp.config(function($routeProvider) {
	$routeProvider
		...
		.when("/SuccessPage", {
			templateUrl: "partials/buy-list.html",
...
myApp.factory("buyService", function() {
	var buy = [];
...
myApp.controller("KartListCtrl", function($scope, kartService, $location ,$rootScope ,buyService) {
...
myApp.controller("buyListCtrl", function($scope, buyService ,kartService) {
	 
	$scope.kart = buyService.getBuy();
